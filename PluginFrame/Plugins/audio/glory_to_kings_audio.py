...
from cqhttp.request_model import MessageSegment
...
@registration_directive(matching=r'#(鸡你太美|小黑子)', message_types=("private", "group"))
class KunKunVoicePlugin(BaseComponentPlugin):
    __name__ = 'KunKunVoicePlugin'
    plu_name = '音频插件'
    desc = "坤坤音乐"
    docs = '#鸡你太美|小黑子'
    permissions = ("all",)
